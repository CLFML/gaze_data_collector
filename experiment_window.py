...
# class ExperimentWindow(QWidget):
#     """Window for running the stimulus presentation of the gaze experiment and collecting data."""
    
#     def __init__(self, setup_folder, setup_config, parent=None):
#         super().__init__(parent)
...
#         self.dot_radius = 10
#         self.dot_display_time = 3000  # 3 seconds
#         self.rest_time = 2000  # 1 second
#         self.grid_points = self.generate_grid_points()
#         self.remaining_points = self.grid_points.copy()
...
#     def generate_grid_points(self):
#         """Generate grid points for dot display with increased spacing."""
#         points = []
        
#         # Define margins as percentage of screen dimensions
#         margin_h = 0.1  # 20% margin from left and right edges
#         margin_v = 0.1  # 15% margin from top and bottom edges
...
#     def paintEvent(self, event):
#         """Handle painting of the dot with increased visibility."""
#         super().paintEvent(event)
...
#         # Draw dot with larger radius and optional white border for visibility
#         x = self.current_dot_position[0] * self.width()
#         y = self.current_dot_position[1] * self.height()
...
#         try:
#             # Save landmarks data
#             landmarks_file = os.path.join(self.setup_folder, "LandmarkData.csv")
...
#     # Create test setup
#     test_folder = "test_experiment/AngleSetups/Y00_P00_D60"
...
#     # Create and show the experiment window
#     window = ExperimentWindow(test_folder, test_config)
#     window.show()
